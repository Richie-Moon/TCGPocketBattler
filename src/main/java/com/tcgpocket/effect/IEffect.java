 ...
 * </ul>
 */
public sealed interface IEffect permits AddStatus, AttachEnergy, BenchFromDeck, AttachFromEnergyZone, AttachTool, ConditionalEffect, DamageEach, DealDamage, DiscardAllEnergy, DiscardFromHand, DiscardRandomEnergy, DiscardTypeEnergy, DistributeEnergy, DrawCard, Fail, HealDamage, HealEach, IDurationEffect, IFlipStrategy, MoveEnergy, MultiHit, NoEffect, PlaceDamage, RemoveStatus, RepeatEffect, SearchDeck, ShuffleDeck, ShuffleHandIntoDeck, SpreadDamage, SwitchActive {
