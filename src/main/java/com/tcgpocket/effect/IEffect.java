 ...
 * </ul>
 */
public sealed interface IEffect permits AddStatus, AttachEnergy, BenchFromDeck, AttachFromEnergyZone, AttachTool, ConditionalEffect, CopyAttack, DamageEach, DealDamage, DiscardAllEnergy, DiscardFromHand, DiscardRandomEnergy, DiscardRandomFromHand, DiscardTypeEnergy, DistributeEnergy, DrawCard, Fail, HealDamage, HealEach, IDurationEffect, IFlipStrategy, MoveEnergy, MultiHit, NoEffect, PlaceDamage, RemoveStatus, RepeatEffect, SearchDeck, ShuffleDeck, ShuffleHandIntoDeck, ShuffleIntoDeck, SpreadDamage, SwitchActive {
